...
const enCommands: CommandHelpRow[] = [
  ...
  },
  {
    ...
    since: '1.4.0',
    usage:
      'FT.SPELLCHECK index query [DISTANCE distance] [TERMS <INCLUDE |\n  EXCLUDE> dictionary [terms [terms ...]]] [DIALECT dialect]',
  },
  {
    key: 'FT.SUGADD',
    title: 'FT.SUGADD',
