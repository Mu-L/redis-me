    ...
    <template #default="{ height }">
      ...
      <me-context ref="meContextRef" @handle-command="handleCommand" @handle-close="handleClose">
        ...
        <template v-else>
          ...
          <el-dropdown-item command="exportFolder" divided v-if="canEdit"><me-icon icon="el-icon-upload" :name="t('keyTree.exportFolder')"/></el-dropdown-item>
          <el-dropdown-item command="deleteFolder"  v-if="canEdit"><me-icon icon="el-icon-delete" :name="t('keyTree.deleteFolder')"/></el-dropdown-item>
        </template>
      </me-context>
    </template>
  </el-auto-resizer>
