...
<b>失败时</b>：优先展示 stderr；退出码非 0 则提示执行失败`,
  ...
  redisACL: {
    title: 'ACL 用户管理',
    notSupportedTitle: '当前实例不支持 ACL',
    notSupportedDesc: 'ACL 需要 Redis/Valkey 6.0 及以上版本',
    currentUser: '当前连接用户',
    keyword: '模糊筛选（用户名/规则）',
    addUser: '新增用户',
    editUser: '编辑用户',
    ...
    password: '密码',
    passwordPlaceholder: '新增时必填；编辑时留空表示不改密码',
    passwordRequired: '请设置密码（新增必填，编辑可留空）',
    passwordGenerated: '已生成随机密码',
    genPassword: '随机生成',
    status: '状态',
    enableSwitch: '启用',
    enabled: '启用',
    ...
    rulePlaceholder: "例如 +{'@'}read、-{'@'}admin",
    keyPatternPlaceholder: '例如 * 或 app:*',
    channelPatternPlaceholder: '例如 * 或 room:*',
    addRule: '添加规则',
    addPattern: '添加模式',
    preview: '命令预览',
    ...
    dangerousBlacklistOn: '已拦截危险命令',
    dangerousBlacklistOff: '不拦截危险命令',
    dangerousBlacklistTip: '开启后会自动追加危险命令禁用规则',
