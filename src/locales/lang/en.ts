...
<b>On failure</b>: stderr is shown first; non-zero exit code shows an exec error`,
  ...
  redisACL: {
    ...
    notSupportedTitle: 'ACL is not supported',
    notSupportedDesc: 'ACL requires Redis/Valkey 6.0 or newer',
    ...
    password: 'Password',
    passwordPlaceholder: 'Required on create; leave empty on edit to keep current password',
    passwordRequired: 'Please set password (required for new user)',
    ...
    selectors: 'Selectors',
    selectorsHint: 'Redis 7.2+ fine-grained rules; each selector is a parenthesized rule set',
    ...
    dangerousBlacklistOn: 'Dangerous commands blocked',
    dangerousBlacklistOff: 'Dangerous commands allowed',
    dangerousBlacklistTip: 'When enabled, dangerous-command deny rule is appended automatically',
    ...
    dryrunTitle: 'ACL DRYRUN - Dry Run Test',
    dryrunCommand: 'Execute Command',
    dryrunCommandPlaceholder: 'e.g., GET key1',
    dryrunResult: 'Test Result',
  },
